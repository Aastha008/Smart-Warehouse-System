...
export default function Layout() {
  ...
  return (
    <div className="w-full h-screen bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 font-sans antialiased flex overflow-hidden transition-colors duration-200">
      {/* Integrated Full-Height Sidebar */}
      <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200/80 dark:border-slate-800 flex flex-col justify-between shrink-0 p-5 z-30 transition-colors duration-200">
        <div>
          {/* Brand Logo & Name */}
          <div className="h-12 flex items-center px-2 gap-3 mb-6">
            <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-[#5136B0] to-[#884FC1] flex items-center justify-center text-white shadow-md shadow-purple-500/25">
          ...
          <div className="relative mt-auto bg-gradient-to-b from-[#F9C35A] to-[#F5AE38] rounded-xl p-4 text-center text-slate-900 pt-6 shadow-sm">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-slate-50 text-slate-900 py-1.5 px-3 rounded-lg text-xs font-bold shadow-xs transition-colors"
            >
              View Safety Rules
            </button>
          </div>
        ...
        <div className="flex-1 flex flex-col min-w-0 bg-white dark:bg-slate-900 overflow-y-auto transition-colors duration-200">
          ...
          <header className="bg-gradient-to-r from-[#443896] via-[#6348B1] to-[#884FC1] dark:from-[#2a1d63] dark:via-[#422985] dark:to-[#5e2e8e] text-white px-6 lg:px-8 pt-6 pb-20 shrink-0 relative transition-colors duration-300">
            ...
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 relative z-10">
              {/* Left Search Bar (Translucent Glass Input) */}
              <div className="relative w-72 sm:w-80">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 bg-white/15 backdrop-blur-md border border-white/20 text-white placeholder:text-white/65 rounded-lg text-xs focus:outline-none focus:bg-white/25 focus:border-white/40 transition-all shadow-inner"
                />
              </div>
              ...
              <div className="flex items-center gap-5 w-full lg:w-auto justify-between lg:justify-end">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="w-8 h-8 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/15 flex items-center justify-center text-white text-xs transition-colors"
                    title="Video Clips"
                  >
                  ...
                  >
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="w-8 h-8 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/15 flex items-center justify-center text-white text-xs transition-colors relative"
          ...
          <main className="w-full px-6 lg:px-8 pb-8 relative z-10 flex-1">
            <Outlet />
          </main>
        </div>
