"""
DockGuard AI - Fun, Creative & Engaging Student Presentation Deck Generator
Written in natural, lively human voice with zero corporate robotic jargon.
"""
import os
import pptx
...
def build_fun_presentation(output_path="Smart_Warehouse_DockGuard_Presentation.pptx"):
    prs = pptx.Presentation()
    prs.slide_width = Inches(13.333)
    prs.slide_height = Inches(7.5)
    blank_layout = prs.slide_layouts[6]

    # Warm, Modern, Student-Friendly Palette
    BG_WHITE = RGBColor(255, 255, 255)
    CARD_BG = RGBColor(248, 250, 252)          # Clean light slate
    CARD_BORDER = RGBColor(226, 232, 240)      # Subtle border
    NAVY_TITLE = RGBColor(24, 43, 73)          # Rich friendly navy (#182B49)
    TEXT_BODY = RGBColor(51, 65, 85)           # Clean slate charcoal (#334155)
    TEXT_MUTED = RGBColor(100, 116, 139)       # Neutral slate (#64748B)
    BRAND_PURPLE = RGBColor(109, 40, 217)      # Lively modern purple (#6D28D9)
    TAG_BG = RGBColor(243, 232, 255)           # Soft purple pill fill
    TAG_TEXT = RGBColor(109, 40, 217)          # Purple pill text
    ...
    ACCENT_ROSE = RGBColor(225, 29, 72)        # Friendly coral rose (#E11D48)
    ...
    def add_header(slide, title_text, pill_tag, confidential=False):
        # Pill Tag
        tag_card = slide.shapes.add_shape(MSO_SHAPE.ROUNDED_RECTANGLE, Inches(0.8), Inches(0.4), Inches(2.8), Inches(0.32))
        tag_card.fill.solid()
        tag_card.fill.fore_color.rgb = TAG_BG
        tag_card.line.fill.background()
    ...
    # =========================================================================
    # SLIDE 1: Solution & Team (Fun, Engaging Hook)
    # =========================================================================
    ...
    top_band.fill.solid()
    top_band.fill.fore_color.rgb = BRAND_PURPLE
    top_band.line.fill.background()

    # Main Project Title
    t1_box = slide1.shapes.add_textbox(Inches(0.8), Inches(1.05), Inches(11.7), Inches(1.4))
    ...
    p1_sub.text = "Because gravity shouldn't win on the loading dock."
    p1_sub.font.name = "Segoe UI"
    p1_sub.font.size = Pt(16)
    p1_sub.font.bold = True
    p1_sub.font.color.rgb = BRAND_PURPLE
    ...
    hook_card.fill.fore_color.rgb = RGBColor(245, 243, 255)  # Very soft violet
    hook_card.line.color.rgb = RGBColor(221, 214, 254)
    ...
    ph1.font.size = Pt(10)
    ph1.font.bold = True
    ph1.font.color.rgb = BRAND_PURPLE
    ...
    p_th.font.bold = True
    p_th.font.color.rgb = NAVY_TITLE
    ...
    for name, title, role in members:
        ...
        run_t.font.color.rgb = BRAND_PURPLE
    ...
    ps_h.font.bold = True
    ps_h.font.color.rgb = NAVY_TITLE
    ...
    highlights = [
        ...
        ("Human Eyes Can't Keep Up:", "A single supervisor can't watch 10 bays, 40 fast-moving workers, and forklift traffic all at once. Blame usually turns into guessing games."),
    ...
    add_header(slide2, "The Mystery of the Smashed Box (And How We Catch It)", "Slide 2: Problem, Solution & User Journey")
    ...
    for i, (stitle, sdesc) in enumerate(flow_steps):
        ...
        scard.fill.fore_color.rgb = TAG_BG if is_highlight else CARD_BG
        scard.line.color.rgb = BRAND_PURPLE if is_highlight else CARD_BORDER
        ...
        p_t.font.size = Pt(10)
        p_t.font.bold = True
        p_t.font.color.rgb = BRAND_PURPLE if is_highlight else NAVY_TITLE
        p_t.alignment = PP_ALIGN.CENTER
    ...
    pr_h.font.bold = True
    pr_h.font.color.rgb = NAVY_TITLE

    ramesh_points = [
        ("The Rush: ", "It's 4:15 PM, 34°C, and Ramesh has 45 minutes to finish packing a 40-foot trailer."),
        ("The Slip: ", "He lifts a 25kg crate without a partner. His grip slips, and the box crashes 1.2 meters to the concrete."),
        ...
        ("The Win: ", "No broken microwave sent to a furious customer, and Ramesh learns to ask for a hand with heavy loads.")
    ]
    ...
    pp_h.font.bold = True
    pp_h.font.color.rgb = BRAND_PURPLE
    ...
    # =========================================================================
    # SLIDE 3: Under the Hood (Tech Stack You Can Explain at 2 AM)
    # =========================================================================
    slide3 = prs.slides.add_slide(blank_layout)
    set_background(slide3)
    add_header(slide3, "Under the Hood: How We Taught Cameras to Care About Boxes", "Slide 3: Technical Architecture & Tech Stack", confidential=True)
    ...
    for idx, (head, items) in enumerate(tech_cards):
        ...
        colors = [ACCENT_BLUE, BRAND_PURPLE, ACCENT_ROSE, ACCENT_AMBER, ACCENT_GREEN, ACCENT_BLUE]
    ...
    add_header(slide4, "In Action: Spotting Drops, Drags & Tilted Pallets", "Slide 4: Prototype Screenshots & Demo")
    ...
    p_sct.font.color.rgb = BRAND_PURPLE
    ...
    add_header(slide5, "What Warehouse Crews Told Us (And How They Roasted Version 1)", "Slide 5: Feedback, Iterations & Real Impact")
    ...
    for i, (role, quote, change) in enumerate(personas):
        ...
        c_line.fill.solid()
        c_line.fill.fore_color.rgb = BRAND_PURPLE if i%2==0 else ACCENT_BLUE
    ...
    add_header(slide6, "The Good, The Glitches & What’s Next", "Slide 6: Conclusion, Real Limitations & Roadmap")
    ...
    bot_card.fill.solid()
    bot_card.fill.fore_color.rgb = TAG_BG
    bot_card.line.color.rgb = RGBColor(221, 214, 254)
    ...
    p_bt.font.bold = True
    p_bt.font.color.rgb = BRAND_PURPLE
    ...
    print(f"Successfully created fun student presentation deck at: {output_path}")

if __name__ == "__main__":
    build_fun_presentation()
